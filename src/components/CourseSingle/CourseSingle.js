...
const CourseSingle = ({ course }) => {
  ...
  return (
    <div className="bg-gray-200 flex flex-col md:flex-row justify-around items-center w-full shadow-lg border border-gray-100 rounded-md ">
      <div className="w-">
